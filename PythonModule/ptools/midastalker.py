...
class MidasTalker(MidasSocket_) :
  ...
  implementation can support your choice.  Choices are:
    0: ARRAY_DISPOSITION_AS_NUMERIC      (DEPRECATED: only use if using XMPY < 4.0.0)
    1: ARRAY_DISPOSITION_AS_LIST         (default)
    2: ARRAY_DISPOSITION_AS_PYTHON_ARRAY (recommended Python 2.5 & up)
    3: ARRAY_DISPOSITION_AS_NUMERIC_WRAPPER (NOT CURRENTLY SUPPORTED)
    4: ARRAY_DISPOSITION_AS_NUMPY        (recommended!!)
